...
// Detect illegal move
int
detect_illegal(char col1, char col2, int rownum1, int rownum2,
...
// Make a move
void 
make_move(char col1, char col2, int rownum1, int rownum2, board_t board) {
...
// Make minimax tree
int
stage_one(board_t board, int action) {
...
void 
make_tree(node_t* root, int action, int depth) {
...
int
all_move(int row, int column, int action, board_t board, action_t actions[]) {
    int actions_num=0;        
    char col1=column+'A';
    int rownum1=row+1;
...
// Stage 1 print
void 
stage_one_print(int action, char col1, int row1, char col2, int row2, 
